...
export default function Header({
  ...
  let usersIcon = (
    ...
    >
      <path
        fill={
          !githubs && !linkedIns && !websites ? color : "rgb(142, 146, 151)"
        }
        fill-rule="evenodd"
        clip-rule="evenodd"
  ...
  function hideMembers() {
    ...
    if (members?.style?.display === "none") {
      ...
      setColor("white");
    } else if (!githubs && !linkedIns && !websites) {
      members.style.display = "none";
      setColor("rgb(142,146,151)");
    }
  }
  function hideGithubs() {
    let members = document.querySelector("aside");
    if (members?.style?.display === "none") {
    ...
    <div className={style.main}>
      ...
      <div className={style.right}>
        <i
          ...
          style={{ color: githubs ? "white" : "rgb(142, 146, 151)" }}
        ></i>
        <i
          ...
          style={{ color: linkedIns ? "white" : "rgb(142, 146, 151)" }}
        ></i>
        <i
          class="fas fa-globe"
          onClick={() => {
          ...
          style={{ color: websites ? "white" : "rgb(142, 146, 151)" }}
        ></i>
        <div
